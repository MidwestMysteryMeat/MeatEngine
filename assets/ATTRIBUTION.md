...
| _(Spacestation_7 vault-only, not staged — large)_ | Fab listing | Spacestation 7 Procedural (`Spacestation_7_-_Procedural-bf84b4bd`) | CC-BY 4.0 | optional vault load |
